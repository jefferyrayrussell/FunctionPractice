...
/* Problem 2  multiply() takes in two numbers as arguments and returns their
product. */
...
/* Problem 3  sumAndMultiply() takes in three numbers as arguments and using the
above functions returns their sum and product. The console logs above need to be
commented out before the function is tested in the console. */
...
/* Problem 4  sumArray() takes in an array of numbers as a single argument and
returns the sum of those numbers. */
function sumArray(arrayOfNumbers) {
  var currentSumOfArrayNumbers = 0;
    /* The function begins with the value zero and adds to it the value of each
    number in the array before proceeding to the next number. */
  ...
  return currentSumOfArrayNumbers;
}

/* Problem 5  multiplyArray() takes in array of numbers as a single argument and
 returns the product of those numbers. */
function multiplyArray(arrayOfNumbers) {
  /* It is necessary to set the value of the variable below to 1 and not 0;
  if 0 this multiplication function would always return 0.*/
  ...
  return currentProductOfArrayNumbers;
}
